...
export function PlayersList({ refreshTrigger = 0 }: PlayersListProps) {
  ...
  const handleSavePlayer = async (updatedPlayer: Player) => {
    try {
      await playerOperations.editPlayer(updatedPlayer.id, updatedPlayer.name, updatedPlayer.cardType)
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          This action cannot be undone. This will permanently delete the player from the system.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
