...
export const  AddReservationSheet :FC<AddReservationSheetProps> = ({ reservation, onSave, trigger }) =>{
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent>
        <form className="space-y-4">
          <SheetHeader>
            <SheetTitle>{reservation ? 'Edit Reservation' : 'Add New Reservation'}</SheetTitle>
            <SheetDescription>
              {reservation ? 'Edit the reservation details.' : 'Create a new reservation and add players to it.'}
            </SheetDescription>
          </SheetHeader>
          ...
          <SheetFooter>
            ...
            >
              {isSubmitting ? 'Saving...' : (reservation ? 'Save Changes' : 'Create Reservation')}
            </Button>
          </SheetFooter>
        </form>
      </SheetContent>
